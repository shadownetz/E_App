    ...
    <div class="popular_courses" id="courses-block">
      <div class="container">
            ...
            <div class="owl-carousel active_course">
              <div class="single_course">
                ...
                <div class="course_content">
                  ...
                  <span class="tag mb-4 d-inline-block">science</span>
                  <h4 class="mb-3">
                  ...
                  >
                    <div class="authr_meta">
                      ...
                      <span class="d-inline-block ml-2">lecturers name | Admin <i class="fa fa-user-md"></i></span>
                    </div>
              ...
              <div class="single_course">
                ...
                <div class="course_content">
                  <span class="price"><i class="fa fa-user"></i></span>
                  <span class="tag mb-4 d-inline-block">Art</span>
                  <h4 class="mb-3">
                    <a href="course-details.html">Literature</a>
                  </h4>
                  <p>
                    One make creepeth man bearing their one firmament won't fowl
                    meat over sea
              ...
              <div class="single_course">
                ...
                <div class="course_content">
                  <span class="price"><i class="fa fa-user"></i></span>
                  <span class="tag mb-4 d-inline-block">general</span>
                  <h4 class="mb-3">
                    <a href="course-details.html">Current Affairs</a>
                  </h4>
                  <p>
                    One make creepeth man bearing their one firmament won't fowl
                    meat over sea
