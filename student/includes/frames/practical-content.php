                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Instruction
                                    <small>
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    <div class="card border border-default">
                                        <div class="card-header">
                                            <strong class="card-title">Observation One:</strong>
                                        </div>
                                        <div class="card-body">
                                        ...
                                        <option value="">Some Text Here</option>
                                        <option value="">Some Text Here</option>
                                        <option value="">Some Text Here</option>
                                    </select>
                                    </div>
                                    ...
                                    <div class="card border border-default">
                                        <div class="card-header">
                                            <strong class="card-title">Observation Two:</strong>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                                                content.
                                    ...
                                    <div class="card border border-default">
                                        <div class="card-header">
                                            <strong class="card-title">Observation Three:</strong>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's
                                                content.
